...
import com.agnext.qualixfarmer.network.Response.ResFarmIndics
    ...
    private fun processLoginState(renderState: UpdateFarmState) {
        ...
        when (renderState) {
            ...
            UpdateFarmState.GetParticularFarmSuccess -> {
                ...
                var farmIndics=ArrayList<ResFarmIndics>()
                if(viewModel.particularFarm.value!!.farmIndics!=null)
                 farmIndics = viewModel.particularFarm.value!!.farmIndics!!
